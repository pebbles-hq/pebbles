            ...
            section(
                ...
                Card::new(column(
                    children![
                        ...
                        gap_h(6.0),
                        row(children![button("Deploy"), button("Cancel").variant(ButtonVariant::Ghost)]).main_axis_min().spacing(10.0),
                    ]).cross_axis_alignment(CrossAxisAlignment::Start).main_axis_min().spacing(8.0)),
            ),
            section(
                "BADGES",
                row(
